"""
Script to make a program from raw machine instructions.

This script makes one that draws some stuff on the screen, then goes into an infinite loop.
"""
nop = b'\x00\x00'
